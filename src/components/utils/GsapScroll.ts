...
export function setCharTimeline(
  ...
  character?.children.forEach((object: THREE.Object3D) => {
    ...
    if (object.name === "screenlight") {
      const screenLightMesh = object as ThemeMesh;
      screenLightMesh.material.transparent = true;
      screenLightMesh.material.opacity = 0;
      screenLightMesh.material.emissive.set("#B0F5EA");
      gsap
        .timeline({ repeat: -1, repeatRefresh: true })
        .to(screenLightMesh.material, {
